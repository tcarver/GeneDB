...
for (org in orgs) {
	...
	def processExecLine = "source /software/pathogen/internal/pathdev/bin/setup_pathpipe_environment.sh; bsub -q ${queueName} -R 'select[mem>2000] rusage[mem=2000]' -M 2000000 -o ${outFileName} -e ${errFileName} ${scriptName}"
